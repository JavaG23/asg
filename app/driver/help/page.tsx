...
export default function DriverHelpPage() {
  ...
  const sections = [
    ...
    { id: 'completing-pickups', title: 'Completing Pickups' },
    { id: 'bag-delivery-routes', title: 'Bag Delivery Routes' },
    { id: 'after-your-route', title: 'After Your Route' },
    { id: 'your-profile', title: 'Your Profile' },
          ...
          <div className="flex-1 min-w-0">
            {loading ? (
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-6">
                <article className="prose prose-gray max-w-none prose-headings:scroll-mt-24 prose-h2:border-b prose-h2:border-gray-200 prose-h2:pb-2 prose-h2:pt-6 first:prose-h2:pt-0 prose-table:text-sm prose-th:bg-gray-50 prose-th:px-3 prose-th:py-2 prose-td:px-3 prose-td:py-2 prose-code:bg-gray-100 prose-code:px-1 prose-code:py-0.5 prose-code:rounded prose-code:text-sm">
                  <ReactMarkdown
                    components={{
